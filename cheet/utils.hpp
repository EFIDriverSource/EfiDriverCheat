...
RGBA ESPColor = { 255,128,0,200 };
RGBA ESPColorx = { 255,128,0,200 };
RGBA Aimfovcolor = { 0,224,128,255 };
...
namespace Settings {
	...
	int distance;
	int MaxSkeletonDrawDistance = 200;
	int hitbox = 2;
	int EspDistance = 200;
	int AimbotDistance = 200;
	float AimbotFOVValue = 120.0f;
	float AimbotSmoothingValue = 1.0f;
